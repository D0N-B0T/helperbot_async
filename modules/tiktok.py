...
async def yt_dlp_sender(update,context,CAPTION):
    ...
    if files.endswith(('avi', 'flv', 'mkv', 'mov', 'mp4', 'webm', '3g2', '3gp', 'f4v', 'mk3d', 'divx', 'mpg', 'ogv', 'm4v', 'wmv')):
            ...
            await context.bot.send_video(reply_to_message_id=update.message.message_id, chat_id=update.message.chat_id, video=open(files, 'rb'), caption = CAPTION, parse_mode='HTML')
